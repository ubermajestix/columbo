...
Columbo.prototype.makeInterface = function() {
  ...
  this.search_input = jQuery('<input type="text" id="_columbo_search"/>')
  ...
  this.columbo_div.append(jQuery('<a id="_columbo_clear">clear</a>').click(function () {jQuery('body').unhighlight()}))

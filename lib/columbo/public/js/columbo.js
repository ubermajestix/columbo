...
Columbo.prototype.build_results_div = function(search_hash, show){
  ...
  if(keys.length > 0){
    jQuery.each(keys, function(index, term){    
        ...
        term = jQuery('<div class="_columbo_term _columbo_next_'+index+'"><div class=\"'+search_hash[term]+'\ _columbo_color_box _columbo_left"></div>'+term+' - '+occurances+'</div>')
        ...
        // jQuery().serialScroll({
        //  items:'.'+search_hash[term],
        //  next:'div._columbo_jump ._columbo_'+index,

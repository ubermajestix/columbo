...
(function(){
  ...
  importJS('http://0.0.0.0:9292/js/jquery-1.3.2.min.js', 'jQuery', function() { // Load everything else when it is done.
    jQuery.noConflict();
    importJS('http://0.0.0.0:9292/js/jquery.scrollto.min.js')  
    importJS('http://0.0.0.0:9292/js/jquery.serialscroll.min.js')  
    importJS('http://0.0.0.0:9292/js/jquery.delay.js')    
    importJS('http://0.0.0.0:9292/js/jquery.highlight.js')
    importJS('http://0.0.0.0:9292/js/jquery.cookie.js')    
